...
# California
Data = filter(Data, State == "Alabama")
...
# Distribution
P1 = ggplot(Data, aes(x = Year, y = Count, fill = Gender)) + geom_bar(stat = "identity", position = "dodge") + labs(title = "Distribution of Alabama Chlamydia Cases by Year",subtitle = "Stratified By Gender", x = "Year", y = "Number of Cases") + theme(legend.position = "none")
...
# California
Data = filter(Data, State == "Colorado")
...
# Distribution
P1 = ggplot(Data, aes(x = Year, y = Count, fill = Gender)) + geom_bar(stat = "identity", position = "dodge") + labs(title = "Distribution of Colorado Chlamydia Cases by Year",subtitle = "Stratified By Gender", x = "Year", y = "Number of Cases") + theme(legend.position = "none")
...
# Distribution
P1 = ggplot(Data, aes(x = Year, y = Count, fill = Gender)) + geom_bar(stat = "identity", position = "dodge") + labs(title = "Distribution of Chlamydia Cases by Year",subtitle = "Stratified By Gender", x = "Year", y = "Number of Cases") + facet_wrap(~State) + theme(strip.text.x = element_text(margin = margin(2, 0, 2, 0)))
P1

# Save
ggsave(P1, file="AllStates.png")
```
#### Explanation
