...
df <-
  ...
  filter(Disease == "Chlamydia", Gender != "Unknown") %>% 
  mutate(
...
table(df2$Gender=='Female')
prop <- sum(df2$Count/df2$Population) #4.96
#table(dependent = Disease, independent = Gender)
#prop.test(x=c(735, 735), n=c(735 + 5 , 735 + 5))
